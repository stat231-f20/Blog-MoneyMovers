...
For example, with our bar graph, we observed that certain business sectors have been more busy than others since 1996. Analysis like this can be linked with other parts of our App, like the visual map, that gives us a different perspective and allows us to piece the puzzle together. Do certain industries have greater influence in certain US states? Which states have had the most IPO's since 1996? How does that line up with each states' major industrial players?
